...
<body  style='margin:0px;'>
 ...
 <br><br>
  ...
  <div style='float:right;width:131.67px;'>{{ preg_replace("/\\s+/iu","", $wanyuanshenghui->lines[1]) }}</div>
...
@else
 ...
 <div style='float:right;width:131.67px;'>{{ preg_replace("/\\s+/iu","", $wanyuanshenghui->lines[0]) }}</div>
