...
<div style='margin-left:26.5px;width:53px;'><div style='width:53px;'>&emsp;</div><div style='width:53px;'>&emsp;</div><?php echo MediaWikiZhConverter::convert(preg_replace("/\\s+/iu","", $wanyuanshenghui->lines[1]), "zh-hk"); ?></div>
@else
