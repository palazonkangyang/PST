...
<body style='margin:0px;'>
 ...
 <div style='border-right:1px solid;border-top:1px solid;border-bottom:1px solid;line-height:1.2;margin:auto;width:263px;height:805px;text-align:center;font-family:LISU;font-weight:BOLD;font-size:59px;'>丙<span style='font-size:53px'>{{ $wanyuanshenghui->block_no }}</span>
 <br>
   <div style='margin-top:6px;height:570px;'>
...
@endif
  ...
  <div style='width:263;height:225px;line-height:1.2;margin:auto;font-size:59px'><div style='width:88.33px;'>&emsp;</div></div>
</div>
  @endforeach
