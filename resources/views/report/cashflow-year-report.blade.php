                      ...
                      <div class="form-body">
                        ...
                        <div class="col-md-12">
                          <table border="1" class="table table-bordered table-striped" id="cashflow-year-report-table">
                            ...
                            <tbody>
                              <tr>
                                <td style="font-weight: bold; text-decoration: underline">银行 Bank Account</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                              ...
                              @for($i = 0; $i < count($ocbc_account); $i++)
                              <tr>
                                <td>{{ $ocbc_account[$i]->type_name }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Jan, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Feb, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Mar, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Apr, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->May, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Jun, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->July, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Aug, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Sep, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Oct, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->Nov, 2) }}</td>
                                <td>{{ number_format($ocbc_account[$i]->December, 2) }}</td>
                              </tr>
                              @endfor

                              <tr>
                                <td style="font-weight: bold; text-decoration: underline">Expense 开支</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
