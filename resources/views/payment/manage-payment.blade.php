                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-8">
                                  <select class="form-control" name="cheque_account" id="cheque_account">
                                    ...
                                    <option value="7">Bank - DBS 星展银行</option>
                                    <option value="8">Bank - Bank of East Asia 东亚银行</option>
                                    <option value="14">Bank - Standard Chartered 渣打银行</option>
                                    <option value="15">Bank - UOB 大华银行</option>
